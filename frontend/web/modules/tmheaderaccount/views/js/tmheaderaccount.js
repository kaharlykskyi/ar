...
tmha = {
    ajax: function () {
        ...
        this.options = {
            type: 'POST', url: baseUri, cache: false, dataType: "json", success: function () {
            }, error: this.error
        };
        ...
        this.options = {selector: 'tmha-sidebar-left', parent: $('body'), content: TMHEADERACCOUNT_CONTENT};
        ...
        this.options = {
            ...
            tpl: {closeBtn: '<a title="Close" class="fancybox-item tmha-close-btn" href="javascript:;"></a>'},
...
function submitRetrieve(elem) {
    var options = {
        ...
        data: {retrievePassword: 1, email: elem.find('[name=email]').val()},
        success: function (jsonData) {
            if (jsonData.hasError) {
                var errors = '';
                for (error in jsonData.errors)
