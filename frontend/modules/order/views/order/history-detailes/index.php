                ...
                <div id="center_column" class="center_column col-xs-12 col-sm-12">
                    ...
                    <div class="block-center" id="block-history">
                        <table id="order-list" class="table table-bordered footab default footable-loaded footable">
                            <thead>
                            <tr>
                                <th class="first_item footable-first-column" data-sort-ignore="true">Order name</th>
                            ...
                            <tr class="first_item ">
                                <td class="history_link bold footable-first-column">
                                    <a href="#">
                                        <img src="img/p/6/6/66-tm_small_default.jpg" alt="DAVIDOFF Women's Cool Water Eau de Toilette Spray">
                                    </a>
                                    <p class="orders-product-name product-name"><a href="#">DAVIDOFF Women's Cool Water Eau de Toilette Spray</a></p>
                                </td>
                                ...
                                <td class="history_method">Payments by check</td>
                                ...
                                <td class="history_invoice">
                                    ...
                                    <a class="color-myaccount" href="javascript:showOrder(1, 6, '');" title="GHLDBXVJY">GHLDBXVJY</a>
                                </td>
                                <td class="history_detail footable-last-column">
                                    <a class="btn btn-default btn-sm btn-base-min" href="javascript:showOrder(1, 6, '');" title="Details">
                                        <span>Details</span>
                                    </a>
                    ...
                    <ul class="footer_links clearfix">
                        <li>
                            <a class="btn btn-default btn-sm btn-base-min" href="account.html" title="Back to Your Account">
                                <span>Back to Your Account</span>
                            </a>
                        </li>
                        <li>
                            <a class="btn btn-default btn-sm btn-base-min" href="index.html" title="Home">
                                <span>Home</span>
                            </a>
                        </li>
                    </ul>
